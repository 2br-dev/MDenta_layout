...
class MorphingAPP{
     ...
     */
    init3JS = ( pointSize, reinitializeCameras = true ) => {
    ...
    initCameras = () => {
        ...
        if( this.actorCamera.position.z == 0 ){
    ...
    animate = () => {
        ...
        Promise.resolve().then(
            ...
            () => {
                ...
                this.actorCamera.lookAt(0, 0, 0);

                this.renderer.render( this.scene, this.activeCamera );
                this.requestAnimationFrameID = window.requestAnimationFrame( this.animate.bind( this ), canvas);
    ...
    morph = ( name, speed ) => {
        ...
        if ( window.innerWidth < 800 ){
            this.mesh.morphTargetInfluences = targetArray;
            return;
        }
        ...
        for ( let i = 0; i < targetArray.length; i++ ){
            if( this.mesh.morphTargetInfluences[ i ] != targetArray[ i ] ){
                this.tweenMorph( i, targetArray[ i ], influenceIndex, speed, name );
            }
        }
    }
     ...
     */
    tweenMorph = ( index, newVal, visibleObjectIndex, speed, name ) => {
        ...
        TweenMax.to( influenceObj, speed, {
            ...
            onComplete: () => {
                ...
                // if ( this.activeMesh.name != this.activeMeshName ){
    ...
    disassemble = ( speed, callBack = () => {} ) => {
        ...
        TweenMax.to(influenceObj, speed, {
            ...
            onUpdate: () => {
                ...
                // if( this.actorCamera.position.z > .1 ){
                //     this.actorCamera.position.z -= .1;
                // }
                ...
                let pointSize = this.pointSize - this.pointSize * percent
    ...
    assemble = ( speed, callback = () => {} ) => {
        ...
        TweenMax.to(influenceObj, speed, {
            ...
            onComplete: () => {
                ...
                this.isAnimating = false;
                // this.morphMaterial.size = this.pointSize;

                for ( let i = 0; i < this.activeMesh.geometry.attributes.position.array.length; i++ ){
                    this.activeMesh.geometry.attributes.position.array[ i ] = this.activeMesh.geometry.attributes.position_original.array[ i ];
                }
